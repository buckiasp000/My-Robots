...
class NEURON: 
    ...
    def Update_Hidden_Or_Motor_Neuron(self, neurons, synapses):
        ...
        for key in synapses.keys():
            if(self.Get_Name() == synapses[key].targetNeuronName):
                self.Allow_Presynaptic_Neuron_To_Influence_Me(synapses[key].Get_Weight(), neurons[key[0]].Get_Value())
        self.Threshold()
    def Allow_Presynaptic_Neuron_To_Influence_Me(self, currentWeight, presynapseValue):
        self.Add_To_Value(currentWeight * presynapseValue)
